...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataAtual = (TextView) findViewById(R.id.dataTelaPrincipal);

        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy", Locale.US);
        dataAtual.setText(sdf.format(Calendar.getInstance().getTime()));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id){
            ...
            case R.id.itemOptionsAtualizar:
                Toast.makeText(this, "Atividades atualizadas", Toast.LENGTH_LONG).show();
                break;
        }
